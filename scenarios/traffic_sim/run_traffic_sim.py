...
def main():
    ...
    sumo_cmd = [
        sumo_binary,
        '--net-file', 'scenarios/traffic_sim/network/net.net.xml',
        '--additional-files', 'scenarios/traffic_sim/network/osm_stops.add.xml,scenarios/traffic_sim/network/osm_pt.rou.xml',
        '--mesosim',
    ...
    if use_gui:
        sumo_cmd.extend([
            '--gui-settings-file', 'scenarios/traffic_sim/network/viewsettings.xml',
            '--delay', '0',
            '--start'
        ])
