...
class MessageUI:
    ...
    def create_window(self):
        ...
        # Title label
        title_label = ttk.Label(main_frame, text="Send Message to All Agents", 
                               font=('Arial', 14, 'bold'))
        ...
        self.message_history = tk.Text(main_frame, height=15, width=50, 
                                       state='disabled', wrap=tk.WORD)
        self.message_history.grid(row=2, column=0, columnspan=2, sticky=(tk.W, tk.E, tk.N, tk.S), 
                                 pady=(5, 10))
        
        # Scrollbar for history
        scrollbar = ttk.Scrollbar(main_frame, orient='vertical', 
                                 command=self.message_history.yview)
