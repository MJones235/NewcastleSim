...
class SUMOMovementProvider(MovementProvider):
    ...
    def spawn_agent(self, agent: Any, spawn_params: dict[str, Any]) -> bool:
        ...
        try:
            ...
            traci.person.appendWalkingStage(person_id, route, 0.0, stopID=destination)
            ...
            traci.person.appendDrivingStage(
                person_id, toEdge=busstop_edge, lines="ANY", stopID=destination
            )
    ...
    def set_agent_target(self, agent: Any, target: Any) -> bool:
        ...
        try:
            ...
            traci.person.appendWalkingStage(agent.person_id, new_route, 0.0, stopID=new_destination)
    ...
    def get_agent_location_info(self, agent: Any) -> dict[str, Any]:
        ...
        try:
            ...
            return {"zone": edge, "edge": edge, "position": position, "angle": angle}
        except traci.exceptions.TraCIException:
            return {"zone": "unknown"}
