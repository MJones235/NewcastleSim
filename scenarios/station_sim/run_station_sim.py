...
def main():
    ...
    sumo_cmd = [
        sumo_binary,
        '--net-file', 'scenarios/station_sim/network/station_network.net.xml',
        '--additional-files', 'scenarios/station_sim/network/osm_stops.add.xml,scenarios/station_sim/network/walking_areas.add.xml',
        '--route-files', 'scenarios/station_sim/network/osm_pt.rou.xml',
        '--pedestrian.model', 'jupedsim',
        '--gui-settings-file', 'scenarios/station_sim/network/viewsettings.xml',
        '--error-log', 'sumo_errors.log',
        '--log', 'sumo.log',
        '--ignore-route-errors',
        '--time-to-teleport', '-1', 
        '--no-step-log', 
        '--step-length', '0.1',  # Fine-grained pedestrian simulation
        '--begin', '0',
