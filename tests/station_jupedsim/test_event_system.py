...
from scenarios.station_jupedsim.core.event_system import EventManager, SimulationEvent
...
class TestSimulationEvent:
    ...
    def test_create_valid_event(self):
        ...
        event = SimulationEvent(time=30.0, action="broadcast_to_all", value="Test message")
